...
// Creates a new MaterialApp using [BookRouterdelegate] and [BookRouterInformationParser]
...
// Parse the browser url and returns path accordingly
// Only usefull in web applications
  ...
  BookRoutePath get currentConfiguration {
    if (appState.selectedIndex == 1) {
      ...
      if (appState.selectedBook == null) {
        ...
        return BooksDetailsPath(appState.getSelectedBookId());
      }
    }
  }
